...
**Objectif** : Sauvegarder un site WordPress en production (o2switch) et le charger localement dans Docker avec configuration adaptée.
...
### 1.2 Créer la configuration o2switch
...
**⚠️ À adapter** : Remplacer `username`, `ssh.o2switch.net` et `YOUR_DB_PASSWORD` par vos vraies valeurs.
...
## 📥 Phase 2 : Sauvegarde depuis o2switch (2 min)
...
# Versions (adaptées à o2switch - example-prod-site.com)
PHP_VERSION=8.1
MYSQL_VERSION=11.4
...
- [x] Configuration o2switch créée et validée
