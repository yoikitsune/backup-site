...
1. [vision.md](vision.md) - Comprendre le projet (5 min)
2. [backlog.md](backlog.md) - Voir les user stories (5 min)
3. [PROGRESS.md](PROGRESS.md) - État d'avancement (5 min)

### 👨‍💻 Je suis Développeur
**Durée** : 30 min

1. [README.md](README.md) - Installation (5 min)
2. [architecture.md](architecture.md) - Architecture (10 min)
3. [IMPLEMENTATION_NOTES.md](IMPLEMENTATION_NOTES.md) - Décisions (10 min)
4. [TESTING.md](TESTING.md) - Comment tester (5 min)

### 🧪 Je suis Testeur
**Durée** : 20 min

1. [TESTING.md](TESTING.md) - Stratégie de test (10 min)
2. [PRODUCTION_TEST_PLAN.md](PRODUCTION_TEST_PLAN.md) - Plan de test (10 min)
...
3. [vision.md](vision.md) - Comprendre le projet (10 min)
4. [architecture.md](architecture.md) - Architecture (10 min)
5. [TESTING.md](TESTING.md) - Comment tester (10 min)
...
| Comprendre le projet | [vision.md](vision.md) | 10 min |
| Installer | [README.md](README.md) | 5 min |
| Configurer | [config/README.md](config/README.md) | 15 min |
| Utiliser | [COMMANDES_COMPLETES_A_Z.md](COMMANDES_COMPLETES_A_Z.md) | 20 min |
| Développer | [architecture.md](architecture.md) + [TESTING.md](TESTING.md) | 30 min |
| Tester | [TESTING.md](TESTING.md) | 20 min |
| Déployer | [docker/production-test/README.md](docker/production-test/README.md) | 30 min |
| État du projet | [PROGRESS.md](PROGRESS.md) | 10 min |
...
### Immédiat
- [ ] Lire [vision.md](vision.md) (5 min)
...
### Moyen terme
- [ ] Lire [IMPLEMENTATION_NOTES.md](IMPLEMENTATION_NOTES.md) (10 min)
- [ ] Lire [PRODUCTION_TEST_PLAN.md](PRODUCTION_TEST_PLAN.md) (15 min)
